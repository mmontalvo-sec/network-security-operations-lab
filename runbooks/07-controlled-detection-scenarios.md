...
**From Kali on redteam1:**
```bash
nmap -p 53,88,135,139,389,445,3389 172.16.20.10
nmap -sT 172.16.20.10
sudo nmap -sS 172.16.20.10
```
...
**From Kali on redteam1:**
```bash
smbclient -L //172.16.20.10 -U fakeuser
# Enter wrong password when prompted
# Repeat 3 times

smbclient -L //172.16.20.10 -U aduser1
# Enter wrong password when prompted
```
...
2. Log in with a valid domain account:
   ...
   - Via SMB: `smbclient -L //172.16.20.10 -U aduser1` with correct password
